...
void CSDKDemoApp::Run(HINSTANCE hInstance)
{
	...
	m_sdk_init_auth_ui->Create(NULL, _T("Pure Sonic"), UI_WNDSTYLE_DIALOG, WS_EX_WINDOWEDGE);
	m_sdk_init_auth_ui->SetIcon(IDI_ICON_LOGO);

	m_sdk_login_ui_mgr->SetEvent(this);
	m_sdk_login_ui_mgr->Create(NULL, _T("Pure Sonic"), UI_WNDSTYLE_DIALOG, WS_EX_WINDOWEDGE);
	...
	//m_more_menu_ui->Create(NULL, _T("Pure Sonic"), UI_WNDSTYLE_DIALOG, WS_EX_WINDOWEDGE);
...
void CSDKDemoApp::onShowLoggedInUI(LoggedIn_MeetingUI_type nType_)
{
	...
	m_sdk_loggedIn_ui_mgr->Create(NULL, _T("Pure Sonic"), UI_WNDSTYLE_DIALOG, WS_EX_WINDOWEDGE);
...
void CSDKDemoApp::onShowSettingsUI(SettingsUI_page nPage)
{
	...
	m_sdk_settings_ui_mgr->Create(NULL,_T("Pure Sonic Settings"),UI_WNDSTYLE_DIALOG, WS_EX_WINDOWEDGE);
